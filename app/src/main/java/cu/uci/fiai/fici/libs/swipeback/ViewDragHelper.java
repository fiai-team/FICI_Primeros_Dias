...
package cu.uci.fiai.fici.libs.swipeback;
...
public class ViewDragHelper {
     ...
     * callback's
     * {@link cu.uci.fiai.fici.libs.swipeback.ViewDragHelper.Callback#onEdgeTouched(int, int)}
     * and
     * {@link cu.uci.fiai.fici.libs.swipeback.ViewDragHelper.Callback#onEdgeDragStarted(int, int)}
    ...
    /**
     * Return the count of an edge. This is the range in pixels along the edges
     * of this view that will actively detect edge touches or drags if edge
     * tracking is enabled.
     *
     * @return The count of an edge in pixels
    ...
    /**
     * Set the count of an edge. This is the range in pixels along the edges of
     * this view that will actively detect edge touches or drags if edge
     * tracking is enabled.
     *
     * @param size The count of an edge in pixels
     */
     ...
     * {@link cu.uci.fiai.fici.libs.swipeback.ViewDragHelper.Callback#tryCaptureView(View, int)}
     ...
     * {@link cu.uci.fiai.fici.libs.swipeback.ViewDragHelper.Callback#getOrderedChildIndex(int)}
     * .
     *
     * @param x X position to test in the parent's coordinate system
     * @param y Y position to test in the parent's coordinate system
