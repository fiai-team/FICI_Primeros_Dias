...
public class Utils {
    ...
    public static final String BLOCK_I = "Bloque 1";
    public static final String BLOCK_II = "Bloque 2";
    public static final String BLOCK_III = "Bloque 3";
    public static final String BLOCK_IV = "Bloque 4";
    public static final String BLOCK_V = "Bloque 5";
    ...
    public static ArrayList<String> toArrayListFromString(String text, char separator) {
    ...
    public static String blockFromGroup(int group, int cantByBlock) {
        if (group <= cantByBlock){
            return BLOCK_I;
        } else if (group > cantByBlock && group <= cantByBlock * 2){
            return BLOCK_II;
        } else if (group > cantByBlock * 2 && group <= cantByBlock * 3){
            return BLOCK_III;
        } else if (group > cantByBlock * 3 && group <= cantByBlock * 4){
            return BLOCK_IV;
        } else {
            return BLOCK_V;
        }
    ...
    public static String blockFromGroup(String group, int cantByBlock) {
        int gr = Integer.valueOf(group.substring(2));

        return blockFromGroup(gr, cantByBlock);
    }
